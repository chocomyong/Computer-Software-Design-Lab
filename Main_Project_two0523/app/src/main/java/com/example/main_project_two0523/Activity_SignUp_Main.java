...
public class Activity_SignUp_Main extends AppCompatActivity {
    ...
    SharedPreferences pref; // 로그인 토큰 유지
    SharedPreferences pref_check; // 자동 로그인 체크 토큰
    ...
    public void SignUpProcess() {
        ...
        task.execute(Server_URL+"signup.php", eID.getText().toString().trim(), ePW.getText().toString().trim(), email.getText().toString().trim());
...
//                email.setText("");
        ...
        protected String doInBackground(String... params) {
            ...
            String postParameters = "user_ID=" + user_ID + "&user_PW=" + user_PW + "&user_email="+user_email;
